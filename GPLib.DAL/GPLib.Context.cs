...
namespace GPLib.DAL
{
    ...
    public partial class GPEntities : DbContext
    {
        ...
        public virtual DbSet<FightDetail> FightDetail { get; set; }
        public virtual DbSet<FightInfo> FightInfo { get; set; }
        public virtual DbSet<DefaultStage> DefaultStage { get; set; }
    }
}
